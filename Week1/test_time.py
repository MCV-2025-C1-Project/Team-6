...
def main(data_dir: Path, k_results: int = 5) -> None:
    ...
    bbdd_descriptors = read_pickle("BBDD/BBDD_descriptors_hs_rgb.pkl")

    # Compute query images descriptors
    img_descriptors = compute_descriptors(images, method="hs_rgb")
    ...
    for metric in metrics:
        ...
        similarities = compute_similarities(img_descriptors, bbdd_descriptors['descriptors'], metric=metric)
        ...
        print(f"MAP@K score: {map_score:.4f}, using {metric} metric.")
